...
import { Bell, CheckCircle, Trash2, Search, Filter, DollarSign } from 'lucide-react';
...
export default function FinanceNotificationsScreen() {
  ...
  return (
    <div className="finance-notifications-screen">
      <div className="notifications-header">
        <div className="header-content">
          <h1>Notifications</h1>
          <p>Stay updated on payment submissions and verifications</p>
        </div>
      ...
      <div className="filters-section">
        ...
        <div className="filter-controls">
          ...
          <select value={typeFilter} onChange={(e) => setTypeFilter(e.target.value)}>
            ...
            <option value="payment">Payment Submissions</option>
